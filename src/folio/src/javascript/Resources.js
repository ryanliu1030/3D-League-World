...
import nunuBodySource from '../models/nunu/nunubot.glb'
import nunuSnowBallSource from '../models/nunu/nunu_snowball.glb'
// Projects
...
export default class Resources extends EventEmitter
{
    constructor()
    {
        ...
        this.loader.load([
            ...
            // Nunu Default
            { name: 'nunuBody', source: nunuBodySource },
            { name: 'nunuSnowball', source: nunuSnowBallSource },
